...
const NoSelected = () => {
  return (
    <div className="min-h-full w-full flex flex-col justify-center items-center text-center bg-white dark:bg-[#0a081f] text-black dark:text-white transition-colors duration-300 relative">
